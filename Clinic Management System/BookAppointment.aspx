            ...
            <div class="form-card">
                ...
                <div class="grid">
                    ...
                    <div>
                        ...
                        <asp:TextBox ID="txtPhone" runat="server" CssClass="textbox" MaxLength="10" placeholder="05XXXXXXXX"></asp:TextBox>
...
<asp:Label ID="lblFeeError" runat="server" CssClass="field-message"></asp:Label>
                    ...
                    <div>
                        ...
                        <asp:DropDownList ID="ddlAppointmentType" runat="server" CssClass="dropdown">
